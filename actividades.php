    ...
    <body>
        ...
        <div class="container">
            <div class="header clearfix">
                <nav>
                    <ul class="nav nav-pills pull-right">
                        ...
                        <li role="presentation" class="active"><a href="actividades.php">Actividades</a></li>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <a id="AgregarNuevo" class="btn btn-primary" style="float: right;"><span class="glyphicon glyphicon-plus"></span> Nueva Actividad</a>
                    </div>
                    <div class="col-md-12">
        ...
        <script type="text/javascript">
            ...
            tabla.bootstrapTable({
                url: "backend/actividades/listActividades.php?fid=-1&esTaller=false",
                method: "POST",
                columns: columnas,
                pagination: "client"
            });
